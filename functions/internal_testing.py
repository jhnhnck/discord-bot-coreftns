...
class CmdTesting(FunctionBase):
  """
  Stub file for jhnhnck_coreftns/internal_testing.py
  Auto-generated by discord-bot-core on 2017-02-15 10:21:10.730611
  """
  ...
  def call(self, args, mod, *_):
    ...
    """
    logger.log('This was a test', log_type=logger.LogLevel.info)
